...
Ресурсы
  ...
  - QoS Class - проставляется автоматически в зависимости от реквестов и лимитов. Есть Burstable, есть Guaranteed, есть 

Best Effort. Последний включается если реквестов и лимитов не задано. Если реквесты равны лимитам - то выставляется Guaranteed. Guaranteed в K8S считаются наиболее важными и критичными приложениями (так как 100% резерв ресурсов)
